...
- Mouse support: drag to select and copy (goes to system clipboard), drag borders to resize, scroll to browse
...
| Context | How to copy |
|---------|-------------|
| **tmux** | Mouse drag to select — automatically copied to system clipboard on release. Or `Prefix + [` to enter copy mode, select text, press `Enter` or `y` to copy. |
